...
(function () {
  ...
  const coverIds = ['siteName', 'workName', 'workLocation', 'startDate', 'finishDate', 'contractorName', 'showContractor'];
  ...
  function coverMarkup(c) {
    ...
    return `<div class="cover-inner ${show ? '' : 'no-contractor'}"><div class="cover-title"><span>工 事 写 真 帳</span></div><div class="cover-spacer"></div><div class="cover-row"><div class="cover-label">現 場 名</div><div class="cover-value">${esc(c.siteName)}</div></div><div class="cover-row"><div class="cover-label">工 事 名</div><div class="cover-value">${esc(c.workName)}</div></div><div class="cover-row"><div class="cover-label">工事箇所</div><div class="cover-value">${esc(c.workLocation)}</div></div><div class="cover-row"><div class="cover-label">工　　期</div><div class="cover-period"><div class="cover-sub-label">着 工</div><div class="cover-value">${esc(c.startDate)}</div></div></div><div class="cover-row"><div></div><div class="cover-period"><div class="cover-sub-label">竣 工</div><div class="cover-value">${esc(c.finishDate)}</div></div></div>${show ? `<div class="cover-row cover-contractor"><div class="cover-label">施 工 者</div><div class="cover-value">${esc(c.contractorName)}</div></div>` : ''}</div>`;
  }
  ...
  function drawCoverCanvas(cover) {
    ...
    drawLongRow('現場名', cover.siteName || '', 512);
    drawLongRow('工事名', cover.workName || '', 682);
    drawLongRow('工事箇所', cover.workLocation || '', 842);

    drawPdfText(ctx, '工期', 245, 997, 25, { font: 'Yu Mincho, Hiragino Mincho ProN, serif' });
    drawPdfText(ctx, '着手', 438, 997, 25, { font: 'Yu Mincho, Hiragino Mincho ProN, serif' });
    drawPdfText(ctx, cover.startDate || '', 705, 997, 26, { align: 'center', font: 'Yu Mincho, Hiragino Mincho ProN, serif' });
    ctx.beginPath();
    ctx.moveTo(370, 1022);
    ctx.lineTo(page.lineRight, 1022);
    ctx.stroke();

    drawPdfText(ctx, '竣工', 438, 1127, 25, { font: 'Yu Mincho, Hiragino Mincho ProN, serif' });
    drawPdfText(ctx, cover.finishDate || '', 705, 1127, 26, { align: 'center', font: 'Yu Mincho, Hiragino Mincho ProN, serif' });
    ctx.beginPath();
    ctx.moveTo(370, 1152);
    ctx.lineTo(page.lineRight, 1152);
    ctx.stroke();

    if ((cover.showContractor || 'yes') !== 'no') {
      drawLongRow('施工者', cover.contractorName || '', 1282);
    }
